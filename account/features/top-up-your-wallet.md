...
# ⬆️ Top up your wallet

## Overview

[Card or bank transfer](top-up-your-wallet.md#card-or-bank-transfer)

[Exchange service](top-up-your-wallet.md#exchange-service)

[Other bitcoin wallet](top-up-your-wallet.md#other-bitcoin-wallet)

[Other crypto wallet](top-up-your-wallet.md#other-crypto-wallet)

## Card or bank transfer

We have partnered with MoonPay and Mt.Pelerin to offer you in-app bitcoin purchases right with your credit card or bank account.

Visit:

{% embed url="https://getalby.com/topup" %}
...
[Binance](https://www.binance.com/) is an established cryptocurrency exchange. You can exchange multiple currencies to bitcoin.

After you acquired bitcoin follow these steps to send bitcoin to your Alby wallet:

1. Click on 'Wallet' in the top bar of your dashboard and select 'Funding Wallet'
2. Click on 'Withdraw' or 'Receive' bitcoin in the list of assets
3. Select 'Lightning' as the 'Network'. The 'Address' field will be automatically changed to 'Invoice'
...
1. Click on 'Withdraw'. (it can take some time until Binance processes the transaction and releases the funds into your Alby Account)

#### Coinbase <a href="#coinbase" id="coinbase"></a>

Follow [these steps](https://help.coinbase.com/en/coinbase/trading-and-funding/sending-or-receiving-cryptocurrency/lightning) to send bitcoin from your Coinbase account to your Alby account.

#### Kraken <a href="#kraken" id="kraken"></a>

[Kraken](https://www.kraken.com/) is an established cryptocurrency exchange. You can exchange multiple currencies to bitcoin.

After you acquired bitcoin follow these steps to send bitcoin to your Alby wallet:

1. Click on 'Funding' in top bar of your dashboard
2. Navigate to the _Account balances_ section and click on 'Withdraw'
3. Choose 'Bitcoin' ![](https://guides.getalby.com/user-guide/~gitbook/image?url=https%3A%2F%2Fcontent.gitbook.com%2Fcontent%2FWKqqWqKEAO8XHGTjzhEl%2Fblobs%2FlhcJLLkyGOOT2dRmnO9M%2Fimage.png\&width=40\&dpr=3\&quality=100\&sign=1efefdaf\&sv=2)
4. Select Lightning Network as the withdrawal method

![](https://guides.getalby.com/user-guide/~gitbook/image?url=https%3A%2F%2Fcontent.gitbook.com%2Fcontent%2FWKqqWqKEAO8XHGTjzhEl%2Fblobs%2FiNf98SiUlSLqsE20RwZM%2Fchrome_Z70Ao0tfrZ.png\&width=768\&dpr=3\&quality=100\&sign=5453b361\&sv=2)
...
1. and Click on 'Add withdrawal request'
2. You will likely have to confirm this withdrawal address. Check your inbox for an email and click on 'Confirm withdrawal address'
