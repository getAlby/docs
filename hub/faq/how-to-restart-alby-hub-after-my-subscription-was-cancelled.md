...
1. Set up a self-hosted Alby Hub on a device of your choice — see the [deployment options](../alby-hub-flavors/) for desktop, cloud, and node hardware.
2. During onboarding, click **“Advanced Setup”**&#x20;
...
3. Click **"Import Existing Recovery Phrase"**
4. Choose an **unlock password** (can be the same as your old one, or a new one) and then **enter your 12-word recovery phrase**.
