...
{% hint style="success" %}
If you have two channels, one is full (too much lightning balance) and the other one is empty (It only has receiving capacity) you can **rebalance** them. [Click here to rebalance your channels if needed.](../faq/can-i-rebalance-funds-from-one-channel-to-another.md)
{% endhint %}
