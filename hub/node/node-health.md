---
description: How to ensure the reliability and efficiency of your node's payments.
---
...
<figure><img src="../.gitbook/assets/Screenshot 2026-04-22 at 10.37.30.png" alt=""><figcaption><p>These are the factors that affect the Node's Health</p></figcaption></figure>
...
Traditionally when using a custodial service which has a single node, that custodial node has _many_ channel partners. If you run your own node and only have one channel, you may struggle to receive or send payments if your channel partner is offline or insufficiently connected.
...
To manage your channel balance, please see the [Node](./) page.
